...
| Native WebUI | Supported Linux x86_64 host-native browser carrier; macOS arm64 remains pending its first exact public publication/readback | App Release Native publication manifest, qualification receipt, and public digest readback |
