...
| One App release tag | macOS arm64 is primary; Full/Linux/Windows append to its tag under asset CAS. Additional delivery failure does not allocate another product version. Docker GHCR publication has independent authority. | [Distribution](delivery/distribution-and-install-ssot.md). |
